// lib/presentation/views/documents/enhanced_document_view.dart
...
class EnhancedDocumentView extends StatefulWidget {
  final Document document;

  const EnhancedDocumentView({super.key, required this.document});

  @override
  State<EnhancedDocumentView> createState() => _EnhancedDocumentViewState();
}

class _EnhancedDocumentViewState extends State<EnhancedDocumentView> {
  ...
  Future<void> _shareDocument() async {
    ...
    try {
      ...
      if (customer != null && user != null) {
        await EnhancedPDFService.shareDocument(
  ...
  Future<void> _printDocument() async {
    ...
    try {
      ...
      if (customer != null && user != null) {
        await EnhancedPDFService.printDocument(
          document: widget.document,
          customer: customer,
          user: user,
        );
  ...
  Future<void> _downloadPDF() async {
    ...
    try {
      ...
      if (customer != null && user != null) {
        final filePath = await EnhancedPDFService.savePDFToDevice(
          document: widget.document,
          customer: customer,
          user: user,
        );
  ...
  Future<void> _previewDocument() async {
    try {
      ...
      if (customer != null && user != null) {
        final previewBytes = await EnhancedPDFService.generatePreviewPDF(
          document: widget.document,
          customer: customer,
          user: user,
        );
